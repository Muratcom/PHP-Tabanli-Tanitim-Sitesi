              ...
              <div class="">
                <div class="fileupload fileupload-new" data-provides="fileupload">
                  ...
                  <span class="fileupload-exists">Değiştir</span>
                   <input type="file" name="sayfagorsel">
                  ...
                  <a href="#" class="close fileupload-exists" data-dismiss="fileupload" style="float: none">×</a>
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" required="" type="text" name="sayfa_baslik" placeholder="Eklemek istediğiniz sayfa başlığını yazınız">
                        </div>  
                        </div> 
                    ...
                    <div class="col-md-12">
                         <div class="form-group col-md-6">
                            ...
                            <input class="form-control" required="" type="text" name="sayfa_yazar" placeholder="Eklemek istediğiniz sayfanın yazarını yazınız">
                        </div>  
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="sayfa_detay" class="ckeditor"></textarea>
                        </div>  
                        </div> 
